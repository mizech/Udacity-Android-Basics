...
public class MainActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        String[] categoriesTitles = { getResources().getString(R.string.category_title_sights),
                                      getResources().getString(R.string.category_title_food),
                                      getResources().getString(R.string.category_title_pubs),
                                      getResources().getString(R.string.category_title_shopping)};
